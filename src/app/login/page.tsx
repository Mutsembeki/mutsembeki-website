  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-hero-gradient px-4">
      ...
      >
        ...
        <div>
          <h1 className="font-display text-2xl font-bold text-gradient">Painel Administrativo</h1>
          <p className="text-muted-foreground text-sm mt-2">Mutsembeki — Ministério Musical</p>
        </div>
        <button
          onClick={() => signIn('google', { callbackUrl: '/admin' })}
          className="btn-primary w-full py-4 gap-3"
        >
        ...
        <p className="text-muted-foreground text-xs">
          Acesso restrito ao administrador do ministério.
        </p>
      </motion.div>
    </div>
  )
